...
class Phonifier:
    def __init__(self, dict_location=None):
        if dict_location is None:
            dict_location = os.path.join("phone_dict")  # Default relative path
...
class TextNormalizer:
    def __init__(self, char_map_location=None):
        if char_map_location is None:
            char_map_location = os.path.join("charmap")  # Default relative path
        self.char_map_location = char_map_location
...
class TTSDurAlignPreprocessor(SharedInit):
    def __init__(self, dict_location=None, **kwargs):
        super().__init__(**kwargs)
        if dict_location:
            self.phonifier = Phonifier(dict_location=dict_location)
